...
# -*- coding: utf-8 -*-
"""
校园网认证脚本 (raasportal) —— OpenWrt 单线四拨 / mwan3 版
...
#   每个账号限 2 个设备: 账号1 负责 vwan0/vwan1, 账号2 负责 vwan2/vwan3
INTERFACES = [
    ...
    {"name": "vwan2", "iface": "eth0mac2", "user": "待填账号2",        "pass": "待填密码2"},
    {"name": "vwan3", "iface": "eth0mac3", "user": "待填账号2",        "pass": "待填密码2"},
]
